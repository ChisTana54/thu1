 ...
 * @author lehie
 */
public class QLTLJPanel extends javax.swing.JPanel {
    ...
    private void showt(){
        db = new DBconnect();
        db.getconnect();
        db.getResult("select * from QLTHELOAI");
        db.connectQL("MATL", "THELOAI");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        db.chucnang("exec themtl '"+this.txma.getText()+"',N'"+this.txten.getText()+"'");
        showt();
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jbnsuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbnsuaActionPerformed
        db.chucnang("exec capnhaptl '"+this.txma.getText()+"',N'"+this.txten.getText()+"'");
        showt();
    ...
    private void jbnxoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbnxoaActionPerformed
        db.chucnang("delete from QLTHELOAI where THELOAI = '"+this.txma.getText()+"'");
        showt();
