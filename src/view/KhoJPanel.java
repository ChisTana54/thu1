...
public class KhoJPanel extends javax.swing.JPanel {
    ...
    private void showt(){
        db = new DBconnect();
        db.getconnect();
        db.getResult("select QLKHOSACH.MAS,TENSACH,SOLUONG  from QLKHOSACH,QLSACH where QLKHOSACH.MAS = QLSACH.MAS");
        db.connectkho();
        db.view_table_kho(tblk, db.kho);
    }
    ...
    private void initComponents() {
        ...
        tblk.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tblkMouseClicked(evt);
            }
        });
    ...
    private void jbnsuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbnsuaActionPerformed
        db.chucnang("exec capnhapqlkhosach '"+this.txms.getText()+"',"+this.txsl.getText()+"");
        showt();
    }//GEN-LAST:event_jbnsuaActionPerformed

    private void tblkMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblkMouseClicked
        pos = this.tblk.getSelectedRow();
        this.jbnsua.setEnabled(true);
        view();
    }//GEN-LAST:event_tblkMouseClicked
