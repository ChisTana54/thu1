 ...
 * @author lehie
 */
public class ngonnguJPanel1 extends javax.swing.JPanel {
    ...
    /**
     * Creates new form ngonnguJPanel
     */
    public ngonnguJPanel1() {
        initComponents();
    ...
    private void showt(){
        db = new DBconnect();
        db.getconnect();
        db.getResult("select * from NGONNGU");
        db.connectQL("MANN", "TENNN");
    ...
    private void initComponents() {
        ...
        jLabel9.setText("Quản lý ngôn ngữ");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        db.chucnang("exec themngonngu '"+this.txma.getText()+"',N'"+this.txten.getText()+"'");
        this.jbnsua.setEnabled(false);
        this.jbnxoa.setEnabled(false); 
        showt();
    ...
    private void jbnsuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbnsuaActionPerformed
        db.chucnang("exec capnhapngonngu '"+this.txma.getText()+"',N'"+this.txten.getText()+"'");
        this.jbnsua.setEnabled(false);
        this.jbnxoa.setEnabled(false); 
        showt();
    ...
    private void jbnxoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbnxoaActionPerformed
        db.chucnang("delete from NGONNGU where MANN = '"+this.txma.getText()+"'");
        this.jbnsua.setEnabled(false);
        this.jbnxoa.setEnabled(false); 
        showt();
